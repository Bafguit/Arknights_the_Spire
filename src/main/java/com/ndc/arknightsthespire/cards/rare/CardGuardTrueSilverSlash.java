...
public class CardGuardTrueSilverSlash extends CardSPBase {
    ...
    public void useCard(AbstractPlayer p, AbstractMonster m, boolean isSpJustUsed) {
        ...
        System.out.println("SP Usage: " + isSpJustUsed);
        System.out.println("Guard Card Amount: " + cardAmount);
        System.out.println("Damage: " + DamageInfo.createDamageMatrix(this.damage, true));
