...
public class SlugC extends AbstractSpriterMonster {
    public static final String ID = "ats:Slug C";
    ...
    public SlugC(float x, float y) {
        ...
        Player.PlayerListener listener = new SlugC.AnimationListener(this);
    ...
    public class AnimationListener implements Player.PlayerListener {
        private SlugC character;

        public AnimationListener(SlugC character) {
