...
public class SlugB extends CustomMonster {
    ...
    private static final String ATLAS = "img/monsters/Slugs/B/enemy_1007_slime_2.atlas";
    private static final String SKEL = "img/monsters/Slugs/B/enemy_1007_slime_2.json";
