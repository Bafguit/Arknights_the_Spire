...
public class Guerilla1 extends CustomMonster {
    public static final String ID = "ats:Guerilla";
    private static final MonsterStrings monsterStrings;
    public static final String NAME;
    public static final String[] MOVES;
    public static final String[] DIALOG;
    private static final String ATLAS = "atsImg/monsters/act_3/enemy_1083_sotiab.atlas";
    private static final String SKEL = "atsImg/monsters/act_3/enemy_1083_sotiab.json";
    ...
    public Guerilla1(float x, float y) {
        ...
        this.damage.add(new DamageInfo(this, 7, DamageInfo.DamageType.NORMAL));
