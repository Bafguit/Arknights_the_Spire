...
public class EndTurnButtonPatcher {
    ...
    static {
        try {
            renderHoldEndTurn = EndTurnButton.class.getMethod("renderHoldEndTurn");
            renderGlowEffect = EndTurnButton.class.getMethod("renderGlowEffect");
...
/*    @SpirePatch(
    ...
    public static class RenderPatcher {
        public static void Replace(EndTurnButton __instance, SpriteBatch sb) throws InvocationTargetException, IllegalAccessException {
            ...
            Color textColor = (Color) getPrivate(__instance, "textColor");
            ...
            System.out.println(holdProgress);
            System.out.println(DISABLED_COLOR);
            System.out.println(ENEMY_TURN_MSG);
            System.out.println(LABEL);
            ...
            if (!Settings.hideEndTurn) {
                ...
                System.out.println("SANS");
                FontHelper.renderFontCentered(sb, FontHelper.panelEndTurnFont, label, current_x + ToggleSpButton.RIGHT_TEXT_OFFSET_X * Settings.scale, tmpY + ToggleSpButton.TEXT_OFFSET_Y * Settings.scale, textColor);
                if (!isHidden) {
                    hb.render(sb);
                }
            }
