...
public class Ambush extends AbstractPower implements CloneablePowerInterface {
    ...
    public Ambush(final AbstractCreature owner, final AbstractCreature source, int eva) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new Ambush(owner, source, evade);
    }
}
