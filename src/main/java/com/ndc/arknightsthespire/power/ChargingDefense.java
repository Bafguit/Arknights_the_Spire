...
public class ChargingDefense extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture("img/power/ChargingDefense_84.png");
    private static final Texture tex32 = TextureLoader.getTexture("img/power/ChargingDefense_32.png");
    ...
    public int onAttacked(DamageInfo info, int damage) {
        if(damage > AbstractDungeon.player.currentBlock && !AbstractDungeon.player.hasPower("Buffer")) {
            flash();
            if (this.amount > 1) {
                addToBot(new ReducePowerAction(AbstractDungeon.player, AbstractDungeon.player, "Charging Defense", 1));
                return 0;
