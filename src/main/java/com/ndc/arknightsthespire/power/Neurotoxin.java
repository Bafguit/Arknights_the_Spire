...
public class Neurotoxin extends AbstractPower implements CloneablePowerInterface {
    ...
    public Neurotoxin(final AbstractCreature owner, final AbstractCreature source, int amount) {
        name = NAME;
        ID = POWER_ID;
        this.amount = amount;
    ...
    public AbstractPower makeCopy() {
        return new Neurotoxin(owner, source, amount);
    }
}
