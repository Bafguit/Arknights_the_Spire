...
public class ResTurnPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public ResTurnPower(final AbstractCreature owner, final AbstractCreature source, int amount, boolean isM) {
        name = NAME;
        ID = POWER_ID;
    ...
    public ResTurnPower(AbstractCreature owner, AbstractCreature source, int amount) {
