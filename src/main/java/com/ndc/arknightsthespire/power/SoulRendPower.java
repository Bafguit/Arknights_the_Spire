...
public class SoulRendPower extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture("atsImg/power/SoulRend_84.png");
    private static final Texture tex32 = TextureLoader.getTexture("atsImg/power/SoulRend_32.png");

    public SoulRendPower(final AbstractCreature owner, final AbstractCreature source, int healAmount) {
        name = NAME;
        ID = POWER_ID;
