...
public class Assault extends CustomRelic {
    public static final String ID = "ats:Assault";
    private static final Texture IMG = TextureLoader.getTexture("atsImg/relics/Assault.png");
