...
public class Attack extends CustomRelic {
    ...
    private static final Texture IMG = TextureLoader.getTexture("atsImg/relics/Attack.png");
    ...
    @Override
    public void onEquip() {
        CardUtil.generateCardReward(CardUtil.getCardPool(PositionType.GUARD), 3);
